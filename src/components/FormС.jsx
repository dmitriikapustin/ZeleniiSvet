	...
	return (
		<div className="flex flex-col form mtm mbm relative">
			<div className='form-top-text flex flex-col z-100'>
				<h2 className='mbs'>Мы готовы вам помочь, потому что знаем как</h2>
				<p className='mb0'>Запишитесь на бесплатную консультацию с одним из наших опытных кредитных экспертов, который проконсультирует вас и предложит индивидуальное решение, соответствующее вашим потребностям</p>
			</div>
			<ScrollAnimation
				delay={0}
			>

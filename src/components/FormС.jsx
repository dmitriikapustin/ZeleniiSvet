	...
	return (
		<div className="flex flex-col form" style={{ margin: '30px 0' }}>
			<div className='form-top-text flex flex-col'>
				<h2 className='font-4-bold form-heading'>Мы поможем решить вашу проблему!</h2>
				<p className='font-2-regular form-text'>Группа Компаний <span className='font-2-bold'>«Зеленый свет»</span> создана, чтобы оказывать качественные финансовые услуги.</p>
			</div>
			<ScrollAnimation
				delay={0}
			>
